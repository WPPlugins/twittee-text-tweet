...
Donate link: http://ai9.co/1b
Tags: twitter, twittee, tweet, timeline, shortcode, hypertext, hyperlink, keywords, link 
...
Please visit the homepage for a short video: <a href="http://johnniejodelljr.com/twittee-text-tweet/">Twittee Text Tweet</a>
...
1. Twittee Shortcode Generator.
2. Twittee generated shortcode to copy and paste in post.
3. Example of shortcode in editor.
4. Example of post and visitor tweeting content.
...
Upgrade needed to correct path to image folder.
